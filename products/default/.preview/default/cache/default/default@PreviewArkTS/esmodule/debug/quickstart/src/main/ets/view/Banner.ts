...
import { BannerClass } from "@normalized:N&&&quickstart/src/main/ets/model/BannerClass&1.0.0";
import { bufferToString } from "@normalized:N&&&quickstart/src/main/ets/util/BufferUtil&1.0.0";
...
export class Banner extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Swiper.create();
            Swiper.debugLine("features/quickstart/src/main/ets/view/Banner.ets(45:5)", "quickstart");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create({ "id": -1, "type": -1, params: [item.imageSrc], "bundleName": "com.example.quickstart", "moduleName": "default" });
                    Image.debugLine("features/quickstart/src/main/ets/view/Banner.ets(48:9)", "quickstart");
